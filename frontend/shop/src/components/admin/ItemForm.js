      ...
      <div>
        <form id="myForm" style={styles.form} action={this.state.formAction}>
          <div style={styles.row}>
            ...
            <input id="name" style={styles.input} type="text"/>
          </div>
          <div style={styles.row}>
            <div style={styles.title}>Color</div>
            <input id="color" style={styles.input} type="text"/>
          </div>
          <div style={styles.row}>
            <div style={styles.title}>Diameter</div>
            <input id="diameter" style={styles.input} type="number"/>
          </div>
          <div style={styles.row}>
            <div style={styles.title}>Weight</div>
            <input id="weigth" style={styles.input} type="number"/>
          </div>
          <div style={styles.row}>
            <div style={styles.title}>Details</div>
            <input id="details" style={styles.input} type="text"/>
          </div>
          <div style={styles.row}>
            <div style={styles.title}>Material</div>
            <input id="material" style={styles.input} type="text"/>
          </div>
          <div style={styles.row}>
            <div style={styles.title}>Manufacturer</div>
            <input id="manufacturer" style={styles.input} type="text"/>
          </div>
          <div style={styles.row}>
            <div style={styles.title}>Short Details</div>
            <input id="shortDetails" style={styles.input} type="text"/>
          </div>
          <div style={styles.row}>
            <div style={styles.title}>Type</div>
            <input id="type" style={styles.input} type="text"/>
          </div>
          <div style={styles.row}>
            <div style={styles.title}>Price</div>
            <input id="price" style={styles.input} type="number"/>
          </div>
          <div style={styles.row}>
            <div style={styles.title}>Amount</div>
            <input id="amount" style={styles.input} type="number"/>
          </div>
...
// <input id="image" style={styles.input} type="file" accept="image/*"/>
// </div>
