...
public class MyController {
    ...
    public String populate() {
        //FOOTBALLS
        Football football1 = new Football("Placeholder1", "Red", 12, 500, "None", "Rubber", "Adidas", 1, 1);
        Football football2 = new Football("Placeholder2", "Green", 15, 1000, "Some details", "Rubber", "Nike", 2, 2);
        Football football3 = new Football("Placeholder3", "Yellow", 13, 3000, "Crappy ball", "Duck skin", "Adidas", 1, 3);
        Football football4 = new Football("Placeholder4", "Red", 22, 2000, "None", "Lamb skin", "Diipadaa", 3, 4);
        Football football5 = new Football("Placeholder5", "Red", 25, 1000, "None", "Plastic", "Adidas", 1, 5);
